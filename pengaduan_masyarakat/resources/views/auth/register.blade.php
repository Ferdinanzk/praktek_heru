...
is-invalid @enderror" id="name" placeholder="Full Name"
...
is-invalid @enderror" id="email" placeholder="Email Address"
...
<input type="text"
class="form-control form-control-user @error('nik')
is-invalid @enderror" id="nik" placeholder="NIK"
...
<input type="text"
class="form-control form-control-user @error('telp')
is-invalid @enderror" id="telp" placeholder="NO.Telp"
